...
export const THEMES = [
  {
    ...
    name: '暖白',
    desc: '干净克制 · 官方可信',
    swatch: ['#f4f1ed', '#c8102e', '#211c1a'],
    vars: mk({
      bg: '#f4f1ed', surface: '#ffffff', surface2: '#f4f1ed', border: '#efe9e3',
      text: '#211c1a', text2: '#4a423d', text3: '#9a928c',
      brand: '#c8102e', softBg: '#fbe9ec', softBorder: '#f6d4da', softText: '#9a3340', accent: '#c8102e',
      chipBg: '#f4f1ed', chipText: '#6b6460',
      shadowCard: '0 16rpx 36rpx -22rpx rgba(60,40,30,0.28)', shadowChip: '0 8rpx 20rpx -10rpx rgba(60,40,30,0.22)',
      bannerBg: '#ffffff', bannerText: '#211c1a', bannerBorder: '#efe9e3',
      ballRed: 'radial-gradient(circle at 33% 28%, #f2666b, #d92b32 58%, #b3151c)',
      ballBlue: 'radial-gradient(circle at 33% 28%, #62a0db, #2566ab 58%, #184c84)',
      ballMain: 'radial-gradient(circle at 33% 28%, #ffb259, #fb8c00 58%, #d97600)',
      ballDigits: 'radial-gradient(circle at 33% 28%, #7bc47f, #43a047 58%, #2f7d33)',
      ballDefault: 'radial-gradient(circle at 33% 28%, #c2bbb5, #9a928c 58%, #7c746e)',
      glowRed: SOFT('196,30,40,0.34'), glowBlue: SOFT('30,90,160,0.32'), glowMain: SOFT('217,118,0,0.32'),
      glowDigits: SOFT('47,125,51,0.32'), glowDefault: SOFT('124,116,110,0.30'),
      pickRed: '#d92b32', pickBlue: '#2566ab',
      heat: ['#eeeeee', '#ffe0b2', '#ffb74d', '#fb8c00', '#e65100'], heatText: '#3a322e', heatMeta: '#6b6460',
      trendBar: '#ffd9d4', trendText: '#c8102e', headerBg: '#faf7f3', gridLine: '#f0ece6', matrixMiss: '#cfc7bf',
    }),
  },
  {
    key: 'dark',
  ...
  },
  {
    ...
    vars: mk({
      ...
      brand: '#c8102e', softBg: '#f8e3cf', softBorder: '#efcfa8', softText: '#a8431f', accent: '#d4a035',
      ...
      ballRed: 'radial-gradient(circle at 33% 28%, #f2666b, #d51a30 58%, #9e0f1c)',
      ballBlue: 'radial-gradient(circle at 33% 28%, #62a0db, #2566ab 58%, #184c84)',
      ballMain: 'radial-gradient(circle at 33% 28%, #ffe09a, #e0a830 58%, #b3791a)',
      ballDigits: 'radial-gradient(circle at 33% 28%, #7bc47f, #43a047 58%, #2f7d33)',
      ballDefault: 'radial-gradient(circle at 33% 28%, #d8c39a, #b89766 58%, #8c6e42)',
      glowRed: SOFT('158,15,28,0.34'), glowBlue: SOFT('30,90,160,0.3'), glowMain: SOFT('179,121,26,0.34'),
      glowDigits: SOFT('47,125,51,0.3'), glowDefault: SOFT('140,110,66,0.3'),
  ...
  },
  {
    ...
    vars: mk({
      ...
      ballRed: 'radial-gradient(circle at 33% 28%, #f06b72, #e1404a 58%, #b8252e)',
      ballBlue: 'radial-gradient(circle at 33% 28%, #6aa6e0, #3a7bc0 58%, #235a92)',
      ballMain: 'radial-gradient(circle at 33% 28%, #ffc06b, #f59a1f 58%, #c9760f)',
      ballDigits: 'radial-gradient(circle at 33% 28%, #74c47a, #46a04c 58%, #2f7d33)',
      ballDefault: 'radial-gradient(circle at 33% 28%, #c4c4c4, #9a9a9a 58%, #6e6e6e)',
      glowRed: SOFT('0,0,0,0.14'), glowBlue: SOFT('0,0,0,0.14'), glowMain: SOFT('0,0,0,0.14'),
      glowDigits: SOFT('0,0,0,0.14'), glowDefault: SOFT('0,0,0,0.14'),
