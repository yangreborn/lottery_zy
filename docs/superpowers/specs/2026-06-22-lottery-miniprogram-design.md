...
## 5. 会员机制与变现（MVP 免费，预留接口）

MVP **完全免费**，仅建表与功能开关占位，后续接入不返工。

### 关键约束（个体开发者，无公司）

- **"跳 H5 付费" 不绕过门槛**：微信支付 / H5 支付**都需要商户号**，商户号需**营业执照**（企业或个体工商户）。
- 个人主体小程序**无法开通微信支付**（个人开发者禁用支付/营销类接口）。
- 因此真正的岔路是「有没有营业执照」，而非"用哪个支付页面"。
- 另注：即便有商户号，**iOS 端小程序仍禁止微信支付购买虚拟商品** → 付费入口走安卓 / H5。

### 变现路线（按推荐度，每步不返工）

**路线 A — 办个体工商户执照（长期最优）**
- 多数城市**即申即发，3–7 天**，成本低。
- 拿照后：小程序转企业/个体类目 → 开通微信支付 → 小程序内/跳 H5 均可收款，体验最佳。

**路线 B — 不办执照的合规变现**
1. **流量主广告（首选起步）**：个人主体小程序即可开通，条件 **UV≥1000 且无违规**，无需商户号、零合规风险。激励视频 / banner。
2. **卡密兑换码（MVP 会员变现）**：在第三方平台（爱发电 / 闲鱼 / 发卡网）售"会员兑换码"，小程序内输入激活。交易在外部平台完成，**无需商户号、合规**。
3. **爱发电订阅**：个人创作者收款做会员，回调/手动激活。

**不推荐 — 第三方个人聚合支付（虎皮椒 / PayJs 等）**
- 可无营业执照在 H5 调起个人微信/支付宝收款（仅走信息流，资金二级商户结算），但**违反微信小程序规则、有封号 + 跑路 + 资金风险**，仅作灰色备选。

### 落地建议

免费 MVP → 变现时**先上流量主广告** → 会员功能用**卡密兑换码激活** → 规模化后**办个体工商户执照接微信支付**。

### 可付费增值点（合规，避开预测）

更长历史数据、冷热号统计、云同步、中奖比对提醒、去广告、开奖推送。
